...
let notificatonSingleItems = document.getElementsByClassName('single-notification');
let removeNotification = document.getElementsByClassName('notification-remove-btn');

for (let i = 0; i < notificatonSingleItems.length; i++) {
  var notificationElement = notificatonSingleItems[i];
}

for (let i = 0; i < removeNotification.length; i++) {
  var removeElement = removeNotification[i];
}
