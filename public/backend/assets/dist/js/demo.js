...
let colorDynamicicon = document.getElementById('colorDynamicMenu');
let colorDynamicbox = document.getElementById('colorDynamicContainer');

colorDynamicicon.addEventListener('click', () => {
  if (colorDynamicbox.style.display === 'none') {
    colorDynamicbox.style.display = 'block'
  } else {
    colorDynamicbox.style.display = 'none'
  }
})



var $affectedElements = $("i, a, span, p, h1, h2, h3, h4, h5, h6");
...
let calculaorBtn = document.getElementById('calculaor-btn');
let calculaorShow = document.getElementById('pos-calcular-show');

calculaorBtn.addEventListener('click', () => {
  if(calculaorShow.style.display === 'none'){
    calculaorShow.style.display = 'block'
  }else{
    calculaorShow.style.display = 'none'
  }
})
...
let paymentRowContainer = document.getElementById('payment-information');
let AppendRow = document.getElementById('multiple-payment-add');
let paymentRowAddBtn = document.getElementById('add-payment-row');

paymentRowAddBtn.addEventListener('click', () => {
    paymentRowContainer.appendChild(AppendRow);
})
