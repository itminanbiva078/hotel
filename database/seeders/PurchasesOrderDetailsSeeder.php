...
class PurchasesOrderDetailsSeeder extends Seeder
{
    /**
    ...
    public function run(Faker $faker)
    {
        // $unixTimestamp = time();
        // for ($i = 0; $i < 2; $i++) :
        //     $purchasesOrderDetails = new PurchasesOrderDetails();
        //     $purchasesOrderDetails->order_id = rand(1, 10);
