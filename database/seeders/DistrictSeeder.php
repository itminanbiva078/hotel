...
class DistrictSeeder extends Seeder
{
    ...
    public function run(Faker $faker)
    {
        ...
        foreach ($districts as $key => $value) :
            ...
            $district->bn_name = $value['bn_name'];
            $district->url = $value['url'];
            $district->lat = $value['lat'];
            $district->lon = $value['lon'];
            $district->updated_by = 1;
            $district->created_by = 1;
            $district->deleted_by = 1;
            $district->save();
        endforeach;
        ...
        $formStructure =  array(
            ...
            'input_field' => array(
                ...
                array(
                    ...
                    'id' => null,
                    'label' => 'District Name',
                    'placeholder' => 'District English Name',
                    'value' => null,
                    'required' => null,
                    'tableshow' => true,
                    'inputShow' => true,
                ...
                array(
                    ...
                    'id' => null,
                    'label' => 'District name',
                    'placeholder' => 'District Bangla Name',
                    'value' => null,
                    'required' => null,
                    'tableshow' => true,
                    'inputShow' => true,
