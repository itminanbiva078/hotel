...
class JournalVoucherSeeder extends Seeder
{
    ...
    public function run(Faker $faker)
    {
        ...
        //     $journalVoucher->voucher_no = rand(1, 10);
            
        //     $journalVoucher->date = $faker->date;
        //     $journalVoucher->debit = $faker->creditCardNumber;
        //     $journalVoucher->credit = $faker->creditCardNumber;
        //     $journalVoucher->note = $faker->text;
        //     $journalVoucher->updated_by = 1;
        //     $journalVoucher->created_by = 1;
        //     $journalVoucher->deleted_by = 1;
        //     $journalVoucher->save();
        // endfor;
        ...
        $formStructure =  array(
            ...
            'input_field' => array(
                ...
                array(
                    ...
                    'validation' => 'required',
                    'readonly' => 'readonly',
                    'voucherInfo' => "journal_voucher_prefix-journal_vouchers",
                ),
                array(
