...
class CreateServiceQuatationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('service_quatations', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('service_status', ['Approved', 'Inactive', 'Pending', 'Cancel'])->default('Pending')->comment('default status set active , penidng status waiting for approbal');         
    ...
    {
        Schema::dropIfExists('service_quatations');
    }
}
