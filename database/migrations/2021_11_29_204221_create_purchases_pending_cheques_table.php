...
class CreatePurchasesPendingChequesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('purchases_pending_cheques', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('purchases_pending_cheques');
    }
}
