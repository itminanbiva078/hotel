...
class CreateSalePendingChequesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sale_pending_cheques', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sale_pending_cheques');
    }
}
