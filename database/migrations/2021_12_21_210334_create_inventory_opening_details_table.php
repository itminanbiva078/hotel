...
class CreateInventoryOpeningDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('inventory_opening_details', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('batch_no')->nullable()->default(0);
    ...
    {
        Schema::dropIfExists('inventory_opening_details');
    }
}
