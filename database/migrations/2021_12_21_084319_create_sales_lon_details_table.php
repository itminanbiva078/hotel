...
class CreateSalesLonDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sales_lon_details', function (Blueprint $table) {
            $table->id();
            ...
            $table->index(['branch_id','sales_lons_id','product_id']);
            $table->softDeletes();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('sales_lon_details');
    }
}
