           ...
           elseif(!empty($details->salesQuatationDetails)):
           ...
           <tr class="new_item<?php echo $parent + $key + 99; ?>">
               ...
               @endif --}}
               <td><input type="text" required=""  name="batch_no[]"  class="form-control batch_no decimal" id="" placeholder="" ></td>
               ...
               <td><input type="number" required=""  name="unit_price[]"
                       ...
                       value="{{$value->unit_price}}" readonly="readonly"></td>
               @endif
