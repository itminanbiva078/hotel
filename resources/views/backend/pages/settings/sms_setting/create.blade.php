    ...
    <div class="col-md-12">
        <div class="card card-default">
            <div class="card-header">
                ...
                @if(helper::roleAccess('settings.sms_setting.index'))
                    <a class="btn btn-default" href="{{ route('settings.sms_setting.index') }}"><i class="fa fa-list"></i>
                    @endif
                        SMS Setting List</a>
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form class="needs-validation" method="POST" action="{{ route('settings.sms_setting.store') }}" novalidate>
                    @csrf
                    <div class="form-row">
