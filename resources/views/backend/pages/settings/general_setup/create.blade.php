        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    @endif
                    <li class="breadcrumb-item active"><span>Add General New Setup</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="col-md-12">
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title">Add New General Setup2</h3>
                <div class="card-tools">
                @if(helper::roleAccess('settings.generalSetup.index'))
                    <a class="btn btn-default" href="{{ route('settings.generalSetup.index') }}"><i class="fa fa-list"></i>
                    ...
                    <div class="card card-default card-tabs">
                        ...
                        <div class="card-body">
                          ...
                          <div class="tab-pane fade show @if($key == 0) active @endif" id="custom-tabs-one-{{$eachCategory}}" role="tabpanel" aria-labelledby="custom-tabs-one-{{$eachCategory}}-tab">
                                ...
                                <form class="form-horizontal" method="POST" action="{{ route('settings.generalSetup.store') }}" novalidate>
                                @csrf
