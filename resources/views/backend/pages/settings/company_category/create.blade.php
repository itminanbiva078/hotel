        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><span>Add New Company Category</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<div class="row">
    <div class="col-md-12">
        <div class="card card-default">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form class="needs-validation" method="POST" action="{{ route('settings.companyCategory.store') }}"
                    novalidate>
                    @csrf
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            <label for="validationCustom01">Company Category Name * :
                            ...
                            <table class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="60%!important;">Sub-Module</th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <td>
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="icheck-primary d-inline">
                                                            <input type="checkbox" name="module_details[]"
