            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a
                            href="{{ route('openingSetup.inventory.index') }}"><i class="fas fa-list">  List</i></a>
                    </li>
                    @endif
        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="card-tools">
                    @if(helper::roleAccess('openingSetup.inventory.index'))
                    <a class="btn btn-default" href="{{ route('openingSetup.inventory.index') }}"><i
                            class="fa fa-list"></i>
                        Opening Inventory  List</a>
                    @endif
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form   onsubmit="return ValidationEvent()" class="needs-validation" method="POST"  action="{{ route('openingSetup.inventory.update',$editInfo->id) }}" novalidate>
