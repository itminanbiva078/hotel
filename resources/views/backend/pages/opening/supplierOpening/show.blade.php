        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('openingSetup.supplierOpening.index') }}">Supplier Opening</a></li>
                    @endif
              ...
              <div class="row no-print">
                <div class="col-md-4">
                  <div class="section-title">
                    <h5><i class="fas fa-file-invoice"></i> Supplier Opening Invoice :</h5>
                  </div>
                </div>
                <div class="col-md-8">
                  ...
                  <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        @php 
                          $tqty = 0;
                        @endphp
                        @foreach($details->supplierOpeningDetails as $key => $eachDetails)
                        @php 
                            $tqty+=$eachDetails->opening_balance;
                          @endphp
                        <tr>
                                <td>{{$key+1}}</td>
                                <td>{{$eachDetails->supplier->name}}</td>
