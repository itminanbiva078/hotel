    ...
    <div class="col-md-12">
        <div class="card card-default">
            <div class="card-header">
                ...
                @if(helper::roleAccess('inventorySetup.brand.create'))
                    <a class="btn btn-default" href="{{ route('inventorySetup.brand.create') }}"><i class="fas fa-plus"></i>
                        Add New</a>
                        @endif
            ...
            <div class="card-body">
                ...
                <form class="needs-validation" method="POST"
                    action="{{ route('inventorySetup.brand.update',$editInfo->id) }}" novalidate>
                    @csrf
