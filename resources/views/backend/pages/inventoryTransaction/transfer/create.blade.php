            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a
                            href="{{ route('inventoryTransaction.transfer.index') }}"><i
                            class="fa fa-list"></i> Transfer List</a>
                    </li>
                    @endif
        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="card-tools">
                    @if(helper::roleAccess('inventoryTransaction.transfer.index'))
                    <a class="btn btn-default" href="{{ route('inventoryTransaction.transfer.index') }}"><i
                            class="fa fa-list"></i>
                        Transfer List</a>
                    @endif
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form enctype="multipart/form-data" class="needs-validation" method="POST"  action="{{ route('inventoryTransaction.transfer.store') }}" novalidate>
                    @csrf
