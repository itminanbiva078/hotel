        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('inventoryTransaction.transfer.create') }}"><i class="fas fa-plus"></i>Add New</a></li>
                    @endif
                    <li class="breadcrumb-item active"><span>Transfer List</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                @if(helper::roleAccess('inventoryTransaction.transfer.create'))
                    <a class="btn btn-default" href="{{ route('inventoryTransaction.transfer.create') }}"><i class="fas fa-plus"></i>Add New</a>
                    @endif
