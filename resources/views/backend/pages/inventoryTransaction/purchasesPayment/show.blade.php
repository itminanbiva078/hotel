        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    @if(helper::roleAccess('inventoryTransaction.purchasesPayment.create'))
                    <li class="breadcrumb-item"><a href="{{route('inventoryTransaction.purchasesPayment.create') }}"><i class="fas fa-plus"> Add </i></a></li>
                    @endif
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="Money-receipt-contant">
              ...
              <table style="width:100%;">
                <tr> 
                  <td> <span> Received With Thanks From :  </span> {{$details->supplier->name}}</td>
                </tr>
              </table>
              <table style="width:100%;">
                <tr> 
              ...
              <table style="width:100%;">
                <tr> 
                  ...
                  <td style="width:50%;"> <span> Contact No:  </span>{{$details->supplier->phone}}   </td>
                </tr>
              </table>
