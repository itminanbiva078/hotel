            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a
                            href="{{ route('inventoryTransaction.purchases.index') }}"><i class="fas fa-list">  List</i></a>
                    </li>
                    @endif
        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="card-tools">
                    @if(helper::roleAccess('inventoryTransaction.purchases.index'))
                    <a class="btn btn-default" href="{{ route('inventoryTransaction.purchases.index') }}"><i
                            class="fa fa-list"></i>
                        Purchases Order List</a>
                    @endif
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form enctype="multipart/form-data"  onsubmit="return ValidationEvent()" class="needs-validation" method="POST"  action="{{ route('inventoryTransaction.purchases.update',$editInfo->id) }}" novalidate>
                    ...
                    <div class="form-row">
                        @foreach ($formInput as $key => $eachInput)
                            ...
                            @if(($eachInput->name == "branch_id" || $eachInput->name == "store_id"))
