        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    @if(helper::roleAccess('inventoryTransaction.inventoryAdjustment.create'))
                    <li class="breadcrumb-item"><a href="{{route('inventoryTransaction.inventoryAdjustment.create') }}"><i class="fas fa-plus"> Add </i></a></li>
                    @endif
                  
                    @if(helper::roleAccess('inventoryTransaction.inventoryAdjustment.index'))
                    <li class="breadcrumb-item"><a href="{{route('inventoryTransaction.inventoryAdjustment.index') }}"><i class="fas fa-list">  List</i> </a></li>
                    @endif
...
<div class="row payment-voucher">
          <div class="col-12">
            <div class="callout callout-info">
              <div class="row no-print">
                <div class="col-md-4">
                  <div class="section-title">
                    <h5><i class="fas fa-file-invoice"></i> Inventory Adjustment Invoice :</h5>
                  </div>
                </div>
                <div class="col-md-8">
                  ...
                  <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        @php 
                          ...
                          $tprice = 0;
                        @endphp 
                        @foreach($details->inventoryAdjustmentDetails as $key => $eachDetails)
                        @php 
