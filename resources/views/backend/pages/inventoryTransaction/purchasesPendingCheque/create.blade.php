        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('inventoryTransaction.purchases.index') }}">Supplier Payment  List</a>  </li>
                    @endif
        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <a class="btn btn-default" href="{{ route('inventoryTransaction.purchases.pendingCheque.index') }}"><i
                            class="fa fa-list"></i>
            ...
            <form class="needs-validation" method="POST"  action="{{ route('inventoryTransaction.purchases.pendingCheque.store') }}" novalidate>
            <!-- /.card-header -->
            <div class="card-body">
...
<script>
    $(document).on('change', '.supplier_id', function() {
        ...
        $.ajax({
                "url": '<?php echo route("inventoryTransaction.purchases.pendingCheque.dueVoucherList"); ?>',
                "dataType": "json",
                "type": "GET",
                "data": {
                    "_token": "<?= csrf_token() ?>",
