        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('accountTransaction.journalVoucher.create') }}"><i class="fas fa-plus"> Add </i></a></li>
                    @endif
                    @if(helper::roleAccess('accountTransaction.journalVoucher.index'))
                    <li class="breadcrumb-item"><a href="{{route('accountTransaction.journalVoucher.index') }}"><i class="fas fa-list">  List</i> </a></li>
                    @endif
              ...
              <div class="row no-print">
                <div class="col-md-4">
                  <div class="section-title">
                    <h5><i class="fas fa-file-invoice"></i> Journal Voucher Invoice :</h5>
                  </div>
                </div>
                <div class="col-md-8">
                ...
                <div class="col-12 table-responsive">
                  <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                      ...
                      $totalCredit = 0;
                      @endphp
                        @foreach($showInfo->journalVoucherLedger as $key => $eachLedger)
                          @php 
