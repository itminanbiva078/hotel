...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"> Service Invoice Transaction</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
...
<div class="row">
    <div class="col-md-12">
        <div class="card card-default">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form   onsubmit="return ValidationEvent()" class="needs-validation" method="POST"  action="{{ route('serviceTransaction.serviceInvoice.update',$editInfo->id) }}" novalidate>
                    @csrf
