        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    @endif
                    <li class="breadcrumb-item active"><span>Service Quatation List</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="col-md-12">
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title">Service Quatation List</h3>
                <div class="card-tools">
                @if(helper::roleAccess('serviceTransaction.serviceQuatation.create'))
                    <a class="btn btn-default" href="{{ route('serviceTransaction.serviceQuatation.create') }}"><i class="fas fa-plus"></i>Add New</a>
                    @endif
