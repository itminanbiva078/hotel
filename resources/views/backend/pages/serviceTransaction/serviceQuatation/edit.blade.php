...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"> Service Quatation Transaction</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a
                            href="{{ route('serviceTransaction.serviceQuatation.index') }}">Service Quatation List</a>
                    </li>
                    @endif
                    <li class="breadcrumb-item active"><span>Add New Service Quatation</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="card-tools">
                    @if(helper::roleAccess('serviceTransaction.serviceQuatation.index'))
                    <a class="btn btn-default" href="{{ route('serviceTransaction.serviceQuatation.index') }}"><i
                            class="fa fa-list"></i>
                        Service Quatation List</a>
                    @endif
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form   onsubmit="return ValidationEvent()" class="needs-validation" method="POST"  action="{{ route('serviceTransaction.serviceQuatation.update',$editInfo->id) }}" novalidate>
                    @csrf
