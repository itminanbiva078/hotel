        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('salesTransaction.salesLoan.create') }}"><i class="fas fa-plus">  Add New</i> </a></li>
                    @endif
    ...
    <div class="col-md-12">
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title">Sales Loan List</h3>
                <div class="card-tools">
                @if(helper::roleAccess('salesTransaction.salesLoan.create'))
                    <a class="btn btn-default" href="{{ route('salesTransaction.salesLoan.create') }}"><i class="fas fa-plus"></i>Add New</a>
                    @endif
