            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a
                            href="{{ route('salesTransaction.salesLoan.index') }}"><i class="fas fa-list"> List</i></a>
                    </li>
                    @endif
...
<div class="row">
    <div class="col-md-12">
        <div class="card card-default">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form enctype="multipart/form-data"  onsubmit="return ValidationEvent()" class="needs-validation" method="POST"  action="{{ route('salesTransaction.salesLoan.store') }}" novalidate>
                    @csrf
