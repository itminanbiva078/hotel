            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a
                            href="{{ route('salesTransaction.salesLoan.index') }}">Sales List</a>
                    </li>
                    @endif
                    <li class="breadcrumb-item active"><span>Add New Sales</span></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="card-tools">
                    @if(helper::roleAccess('salesTransaction.salesLoan.index'))
                    <a class="btn btn-default" href="{{ route('salesTransaction.salesLoan.index') }}"><i
                            class="fa fa-list"></i>
                        Sales List</a>
                    @endif
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form enctype="multipart/form-data"   onsubmit="return ValidationEvent()" class="needs-validation" method="POST"  action="{{ route('salesTransaction.salesLoan.update',$editInfo->id) }}" novalidate>
                    @csrf
