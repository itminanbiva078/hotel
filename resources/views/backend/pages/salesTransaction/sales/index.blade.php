        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('salesTransaction.sales.create') }}"><i class="fas fa-plus">  Add New</i> </a></li>
                    @endif
        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                @if(helper::roleAccess('salesTransaction.sales.create'))
                    <a class="btn btn-default" href="{{ route('salesTransaction.sales.create') }}"><i class="fas fa-plus"></i>Add New</a>
                    @endif
