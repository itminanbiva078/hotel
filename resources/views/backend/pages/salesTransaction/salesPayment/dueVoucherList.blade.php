        ...
        <div class="col-12 table-responsive">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        @foreach($dueVoucherList as $key => $eachResult)
                            @php 
                                $pamount+=$eachResult->salesAmount;
                            ...
                            <tr>
                                ...
                                <td>
                                <input type="hidden" name="sale_voucher_id[]" value="{{$eachResult->voucher_id}}"/>
                                <input type="text" readonly class="form-control salesAmount" value="{{$eachResult->voucher_no}}"></td>
                                <td><input type="number"  name="sales_amount[]" readonly class="form-control salesAmount" value="{{$eachResult->salesAmount}}"></td>
                ...
                @else 
                  <div class="alert alert-default" role="alert">
                    Sorry , selected customer have no due sales!
                  </div>
                @endif
            </div>
        </div>
