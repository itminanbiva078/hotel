            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    @foreach($dueVoucherList as $key => $eachResult)
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="hidden" name="purchases_voucher_id[]" value="{{$eachResult->id}}"/>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td class="text-right">{{helper::pricePrint($pamount)}}</td>
                        <td class="text-right">{{helper::pricePrint($tpayment)}}</td>
                        <td class="text-right">{{helper::pricePrint($damount)}}</td>
                        <td class="text-right "><span class="ppaymentnow">{{helper::pricePrint($damount)}}</span></td>
                        <td class="text-right "><span class="pdueamount">0.00</span></td>
                    </tr>
                    <tr>
                        <td colspan="7"></td>
