...
<div class="row">
    <div class="col-md-12">
        <div class="card card-default">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form enctype="multipart/form-data"  onsubmit="return ValidationEvent()" class="needs-validation" method="POST"  action="{{ route('salesTransaction.salesQuatation.update',$editInfo->id) }}" novalidate>
                    @csrf
