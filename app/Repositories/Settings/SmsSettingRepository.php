        ...
        if ($smsSettings) {
            foreach ($smsSettings as $key => $smsSetting) {
                ...
                if ($smsSetting->status == 'Approved') :
                    ...
                    $status = '<input  class="status_row" status_route="' . route('settings.sms_setting.status', [$smsSetting->id, 'Approved']) . '"  id="toggle-demo" type="checkbox" name="my-checkbox"  data-bootstrap-switch data-off-color="danger" data-on-color="success">';
                endif;
